...
export const KITS_SEED = [
  ...
  { id: 17, slug: 'team-socks',       emoji: '🧦', image: teamSocksImg,      name: 'Team Socks',          sport: 'others',     desc: 'Knee-high team socks with cushioned sole and ribbed cuff.', color: '#0a3a1a' },
